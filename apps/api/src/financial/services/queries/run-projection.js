import { getBranchLineageIds, getCommitsByBranchIds, getActionsByCommitIds, getGoalsByBranchIds } from "../../repos/branch-lineage.repo";
import { getAccountingEntities, getEnvVars } from "../../repos/accounting.repo";
import { ReplayEngine } from "../../engine/replay-engine";
/**
 * Orchestrates a financial projection for a specific branch.
 */
export async function runProjection(db, branchId, durationMonths = 120, asOf = new Date()) {
